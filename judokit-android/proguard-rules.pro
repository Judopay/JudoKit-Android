# ============================================================================
# JudoKit-Android SDK - Library ProGuard/R8 Rules
# ============================================================================
# These rules are applied when building the library module itself.
# They ensure proper functionality when minification is enabled during
