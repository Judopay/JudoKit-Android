...
internal class RegisterCardRequestTest {
    ...
    fun exceptionOnNullCurrency() {
        assertThrows<IllegalArgumentException> {
            request.setCurrency(null).build()
        }
    }
    ...
    fun exceptionOnNullCardNumber() {
        assertThrows<IllegalArgumentException> {
            request.setCardNumber(null).build()
        }
    }
    ...
    fun exceptionOnNullExpiryDate() {
        assertThrows<IllegalArgumentException> {
            request.setExpiryDate(null).build()
        }
    }
