 ...
 * via the show method.
 * @param service An instance of [JudoApiService] created through [com.judokit.android.api.factory.JudoApiServiceFactory].
 * @param cardVerificationModel A model that contains all the necessary parameters to pass 3DS authentication.
 * The parameters are obtained from [com.judokit.android.api.model.response.Receipt] model.
