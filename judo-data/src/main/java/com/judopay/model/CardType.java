...
public class CardType {
    ...
    public static final String[] AMEX_PREFIXES = {"34", "37"};
    public static final String[] VISA_PREFIXES = {"4"};
    public static final String[] MASTERCARD_PREFIXES = {"50", "51", "52", "53", "54", "55"};
