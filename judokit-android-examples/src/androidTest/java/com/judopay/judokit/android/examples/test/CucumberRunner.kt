package com.judopay.judokit.android.examples.test
...
@CucumberOptions(
    features = ["features"],
    glue = ["com.judopay.judokit.android.examples.test.steps"]
)
class CucumberRunner : CucumberAndroidJUnitRunner() {
    ...
    private fun getAbsoluteFilesPath(): String {
        // sdcard/Android/data/com.judopay.judokit.android.examples
