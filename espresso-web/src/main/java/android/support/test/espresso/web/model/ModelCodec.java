...
public final class ModelCodec {
  ...
  private static final Collection<Class<?>> VALUEABLE_CLASSES = ImmutableSet.of(
      Boolean.class, Number.class, String.class, JSONObject.class, JSONArray.class);

  private static final Collection<Class<?>> TOP_LEVEL_CLASSES = ImmutableSet.of(
      JSONObject.class, JSONArray.class, Iterable.class, Object[].class, Map.class,
      JSONAble.class);
