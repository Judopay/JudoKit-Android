...
import com.judopay.ui.paymentmethods.PaymentMethodsAction
...
internal class CardEntryViewModelFactory(private val application: Application,
                                         private val judo: Judo) : ViewModelProvider.NewInstanceFactory() {
...
class CardEntryViewModel(application: Application,
