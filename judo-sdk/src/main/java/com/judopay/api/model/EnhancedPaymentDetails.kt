...
class SDKInfo(@field:SerializedName("Version") private val version: String,
              @field:SerializedName("Name") private val name: String)

class ConsumerDevice(@field:SerializedName("IpAddress") val ipAddress: String,
...
class ClientDetails(val key: String,
                    val value: String)
...
class Browser(@field:SerializedName("Language") private val language: String,
...
class EnhancedPaymentDetail(@field:SerializedName("SDK_INFO") val sdkInfo: SDKInfo,
