...
class PreAuthPresenter extends BasePaymentPresenter {
    ...
    public PreAuthPresenter(PaymentFormView paymentFormView, JudoApiService apiService, Scheduler scheduler, Payment payment) {
    ...
    protected Observable<Receipt> performApiCall(Card card, Consumer consumer) {
        ...
        return apiService.preAuth(builder.build());
    }
}
