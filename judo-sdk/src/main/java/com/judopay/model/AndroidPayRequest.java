...
public final class AndroidPayRequest extends BasePaymentRequest {
    ...
    public AndroidPayRequest(String encryptedMessage, String ephemeralPublicKey, String tag) {
        super(true);
    ...
    public static class Builder {
         ...
         *
         * @param paymentMethodToken the string containing the payment method json received from
        ...
        public AndroidPayRequest build() {
            AndroidPayRequest androidPayRequest = new AndroidPayRequest(encryptedMessage, ephemeralPublicKey, tag);
