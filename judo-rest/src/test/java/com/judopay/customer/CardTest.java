...
public class CardTest {
    ...
    public void shouldHaveInvalidLuhn() {
        Card card = new Card("1234567890123456", null, new CardDate(1, 99), null);
        assertThat(card.isLuhnValid(), is(false));
    }

    @Test
    public void shouldHaveValidLuhn() {
        Card card = new Card("4976000000003436", null, new CardDate(1, 99), null);
        assertThat(card.isLuhnValid(), is(true));
    }

    @Test
    public void shouldHaveValidStartDate() {
        Card card = new Card("4976000000003436", new CardDate(1, 12), null, null);
        assertThat(card.isStartDateValid(), is(true));
    }

    @Test
    public void shouldHaveInvalidStartDate() {
        Card card = new Card("4976000000003436", new CardDate(1, 99), null, null);
    ...
    public void shouldHaveInvalidCidvAmexCard() {
        Card card = new Card("340000000000009", null, null, "10001");
    ...
    public void shouldHaveValidCv2VisaCard() {
        Card card = new Card("4111111111111111", null, null, "0123");
    ...
    public void shouldHaveInvalidCv2VisaCard() {
        Card card = new Card("4111111111111111", null, null, "1001");
